...
function overHome(demo) {
  document.getElementById(demo).style.background="rgba(5,91,130,1)"
}

function outHome(demo) {
  document.getElementById(demo).style.background="rgba(7,137,195,1)"
}